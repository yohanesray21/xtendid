...
function AddItemSales({ purchaseId, setListItemOrder, setTotalItemOrder }) {
  ...
  const addItem = async () => {
    ...
    await axios.post(
      "https://xtendid.herokuapp.com/api/item-po-store",
      {},
      {
        params: {
          po_id: purchaseId,
    ...
    const url = `https://xtendid.herokuapp.com/api/item-po-get/${purchaseId}`;
